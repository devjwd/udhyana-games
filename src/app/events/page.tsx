...
export default function EventsPage() {
  ...
  const tournaments = [
    {
      id: 1,
      title: 'EA Sports FC 25 Weekend Cup',
      date: 'Every Saturday & Sunday',
      prize: 'PKR 15,000 + Trophy',
      game: 'FC 25 (PS5 Pro)',
      status: 'Registering',
    },
    {
      id: 2,
      title: 'Tekken 8 King of the Iron Fist',
      date: 'Bi-Weekly Friday Night',
      prize: 'PKR 20,000 + Arcade Pass',
      game: 'Tekken 8 (PS5 Pro)',
      status: 'Registering',
    },
    {
      id: 3,
      title: 'Valorant 5v5 LAN Championship',
      date: 'Monthly Arena Major',
      prize: 'PKR 50,000 Prize Pool',
      game: 'Valorant (240Hz PC)',
      status: 'Upcoming',
    },
  ];
